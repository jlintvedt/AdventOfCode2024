...
namespace AdventOfCodeTests
{
    ...
    public class Day17Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day17.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day17.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
