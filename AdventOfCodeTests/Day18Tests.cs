...
namespace AdventOfCodeTests
{
    ...
    public class Day18Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day18.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day18.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
