...
namespace AdventOfCodeTests
{
    ...
    public class Day14Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day14.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day14.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
