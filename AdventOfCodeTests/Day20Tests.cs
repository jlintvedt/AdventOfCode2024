...
namespace AdventOfCodeTests
{
    ...
    public class Day20Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day20.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day20.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
