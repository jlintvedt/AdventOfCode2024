...
namespace AdventOfCodeTests
{
    ...
    public class Day13Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day13.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day13.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
