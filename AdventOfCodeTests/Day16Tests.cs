...
namespace AdventOfCodeTests
{
    ...
    public class Day16Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day16.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day16.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
