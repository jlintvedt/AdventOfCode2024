...
namespace AdventOfCodeTests
{
    ...
    public class Day12Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day12.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day12.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
