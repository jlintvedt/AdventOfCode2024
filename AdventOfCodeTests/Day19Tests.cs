...
namespace AdventOfCodeTests
{
    ...
    public class Day19Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day19.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day19.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
