...
namespace AdventOfCodeTests
{
    ...
    public class Day09Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day09.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day09.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
