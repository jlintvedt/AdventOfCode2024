...
namespace AdventOfCodeTests
{
    ...
    public class Day08Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day08.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day08.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
