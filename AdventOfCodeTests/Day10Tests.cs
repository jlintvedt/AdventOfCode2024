...
namespace AdventOfCodeTests
{
    ...
    public class Day10Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day10.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day10.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
