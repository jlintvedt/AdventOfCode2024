...
namespace AdventOfCodeTests
{
    ...
    public class Day15Tests
    {
        ...
        {
            // Act
            var result = AdventOfCode.Day15.Puzzle1(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
        ...
        {
            // Act
            var result = AdventOfCode.Day15.Puzzle2(InputProvider.GetExample(AdventOfCode.Const.Year, day, exampleNum: 1));
